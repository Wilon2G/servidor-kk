...
<body>
    ...
    <?php
    use Daw2\AppLibroComposer\Book;
    use Daw2\AppLibroComposer\Customer;
    ...
    if (isset($_POST["rentBook"])) {
        Book::showAllBooks("rentBook");
        if (isset($_POST["chosenBook"])) {
            //var_dump($_POST["chosenBook"]);
            $chosenBook=Book::fromId($_POST["chosenBook"]);

            $customer=Customer::getCustomer($_SESSION["logedUser"]["id"]);
